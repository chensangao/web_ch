    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a class='news-ctrl-l' href='$mlink'><img src='/skin/images/ctrl-one-img-l.png'><span class='words'>上一篇</span></a> ";
            ...
            {
                $this->PreNext['pre'] = "<a class='news-ctrl-l'><img src='/skin/images/ctrl-one-img-l.png'><span class='words'>没有了</span></a> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a class='news-ctrl-r' href='$mlink'><img src='/skin/images/ctrl-one-img-r.png'><span class='words'>下一篇</span></a> ";
            ...
            {
                $this->PreNext['next'] = "<a class='news-ctrl-r'><img src='/skin/images/ctrl-one-img-r.png'><span class='words'>没有了</span></a> ";
